...
class VisDroneDataset(BaseDataset):
    ...
    def __init__(self):
        ...
        self.base_path = '/home/xyl/pysot-master/testing_dataset/VisDrone2019-SOT-test-dev'
    ...
    def _construct_sequence(self, sequence_info):
        ...
        anno_path = '{}_annotations/{}'.format(self.base_path, sequence_info['anno_path'])
        # NOTE: OTB has some weird annos which panda cannot handle
        ground_truth_rect = load_text(str(anno_path), delimiter=(',', None), dtype=np.float64, backend='numpy')

        return Sequence(sequence_info['name'], frames, 'visdrone', ground_truth_rect[init_omit:, :],
    ...
    def _get_sequence_info_list(self):
        ...
        for root, dirs, files in os.walk('/home/xyl/pysot-master/testing_dataset/VisDrone2019-SOT-test-dev'):
            for dir in dirs:
                if dir == 'img':
        ...
        for i in range(len(sequence_dir)):
            ...
            sequence_info["anno_path"] = os.path.join(sequence_info["name"]+'.txt')  # 标注文件为uav0000011_00000_s.txt
